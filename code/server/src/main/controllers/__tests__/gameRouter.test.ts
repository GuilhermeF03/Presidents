import { Rank, Suit } from '@core/model/game/card.ts';
import type { PlayCardInput } from '@core/model/game/inputs.ts';
import type { Profile } from '@core/model/game/player.ts';
import { deepEqual, when } from 'ts-mockito';
import { v4 as uuid } from 'uuid';
import { expectValidationError, mockCaller, mockServices } from './utils.ts';
