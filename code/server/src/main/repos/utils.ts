import { type ActiveGameState, type FinishedGameState, type PendingGameState, Role } from '@core/model/game/State.ts';
import type { GamePlayerInfo, Hand, Profile } from '@core/model/game/player.ts';
